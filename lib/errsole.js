...
function createLogger (level) {
  return function (...args) {
    ...
    if (this.metadata && (typeof this.metadata === 'object' || Array.isArray(this.metadata)) && this.metadata !== null) {
      let metadataString;
      try {
        metadataString = util.inspect(this.metadata, { depth: null });
      } catch (e) {
        metadataString = String(this.metadata);
      }
      metadataString = metadataString.length > maxLength ? metadataString.substring(0, maxLength) + '...' : metadataString;
