  ...
  try {
    ...
    if (this.transporter !== null) {
      ...
      if (data && data.item) {
        ...
        // Add notice
        if (type === 'Alert') {
          message = `${message}<p><i>Note:<ul><li>You will not receive another notification for this alert on this server within the current hour.</li><li>Errsole uses the UTC timezone in notifications.</li></ul></i></p>`;
        } else {
          message = `${message}<p><i>Note:<ul><li>You will not receive another notification for this error on this server within the current hour.</li><li>Errsole uses the UTC timezone in notifications.</li></ul></i></p>`;
        }
