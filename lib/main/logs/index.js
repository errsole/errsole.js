...
CollectLogsHook.customLogger = function (level, message) {
  try {
    const logEntry = { timestamp: new Date().toISOString(), message, source: 'errsole', level, hostname: this.hostname || '', pid: this.pid || 0 };
