...
class Integrations extends React.Component {
  ...
  addEmailDetails () {
    ...
    const recipients = emailDetails?.recipients;
    const receiversArray = recipients ? recipients.split(',') : [];
  ...
  render () {
    ...
    const selectedUsers = Array.isArray(this.state.selectedUsers) ? this.state.selectedUsers : (typeof emailDetails?.recipients === 'string' && emailDetails.recipients ? emailDetails.recipients.split(',') : []);
                      ...
                      <>
                        <Form layout='horizontal'>
                          ...
                          <Form.Item>
                            ...
                            <Select className='input-class-margin' name='recipients' mode='multiple' placeholder="Select Recipient's Email Address" value={selectedUsers} onChange={this.handleChange.bind(this)} style={{ width: '400px' }}>
