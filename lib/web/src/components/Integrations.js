              ...
              <Content className='setting-user'>
                ...
                <Tabs tabPosition='left'>
                  <TabPane tab={<span><Icon type='slack' />Slack</span>} key='2'>
                    ...
                    {slackDetails && <Result status='success' title={slackStatus ? 'Slack Integrated' : 'Slack Notifications Paused'} subTitle={slackStatus ? 'You will receive notifications for app downtime and custom alerts directly on Slack.' : 'You have paused Slack notifications for app downtime and custom alerts.'} extra={[<Button type='primary' onClick={this.updateSlackNotifications.bind(this, !slackStatus)} key='1'> {slackStatus ? 'Pause Notifications' : 'Resume Notifications'} </Button>, <Button type='danger' onClick={this.deleteSlack.bind(this)} key='2'> Remove Slack </Button>]} />}
                  </TabPane>
                </Tabs>
              </Content>
            </Content>
