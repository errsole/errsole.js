                      ...
                      <>
                        <Form layout='horizontal'>
                          <Form.Item>
                            ...
                            <Input className='password-class' value={password} style={{ width: '400px', marginBottom: '8px' }} name='password' placeholder='Password' onChange={this.handleFormChange.bind(this)} autocomplete='off' /><br />
