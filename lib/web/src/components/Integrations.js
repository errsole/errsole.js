            ...
            <Content className='all-intergrations'>
              <Content>
                ...
                <Tabs tabPosition={tabPosition} className='integrations'>
                  <TabPane tab={<span><SlackOutlined className='tab-icon' />Slack</span>} key='2'>
                    ...
                    {slackDetails && <Result status='success' title={slackStatus ? <span><CheckCircleFilled style={{ color: 'green' }} theme='filled' className='custom-check' /> Slack Integrated</span> : <span><PauseCircleFilled style={{ color: 'orange' }} theme='filled' /> Slack Notifications Paused</span>} subTitle={slackStatus ? 'You will receive notifications for app downtime and custom alerts directly on Slack.' : 'You have paused Slack notifications for app downtime and custom alerts.'} extra={[<Button type='primary' onClick={this.updateSlackDetails.bind(this, !slackStatus)} key='1'> {slackStatus ? 'Pause Notifications' : 'Resume Notifications'} </Button>, <Button type='primary' danger onClick={this.deleteSlackDetails.bind(this)} key='2'> Remove </Button>, <Button type='primary' ghost onClick={this.testNotifications.bind(this, 'slack')} key='3' loading={testNotificationLoading}> Test Notification </Button>]} />}
                  </TabPane>
                  <TabPane tab={<span><MailOutlined className='tab-icon' />Email</span>} key='3'>
                    {(!emailDetails || editEmailDetails) &&
                      <>
                        <Form layout='horizontal'>
                          <Form.Item>
                            <Input value={host} style={{ width: '400px', marginBottom: '8px' }} name='host' placeholder='SMTP Host' onChange={this.handleFormChange.bind(this)} autocomplete='off' /><br />
                            <Input value={port} style={{ width: '400px', marginBottom: '8px' }} name='port' placeholder='SMTP Port' onChange={this.handleFormChange.bind(this)} autocomplete='off' /><br />
                            <Input value={username} style={{ width: '400px', marginBottom: '8px' }} name='username' placeholder='Username' onChange={this.handleFormChange.bind(this)} autocomplete='off' /><br />
                            <Input value={password} style={{ width: '400px', marginBottom: '8px' }} name='password' placeholder='Password' onChange={this.handleFormChange.bind(this)} autocomplete='off' /><br />
                            <Input value={sender} style={{ width: '400px', marginBottom: '8px' }} name='sender' placeholder="Sender's Email Address" onChange={this.handleFormChange.bind(this)} autocomplete='off' /><br />
                            <Select name='receivers' mode='multiple' placeholder="Select Recipient's Email Address" value={selectedUsers} onChange={this.handleChange.bind(this)} style={{ width: '400px', marginBottom: '8px' }}>
              ...
              <Spin indicator={antIcon} spinning={alertUrlLoading} delay={100}>
                <Form layout='horizontal' style={{ textAlign: 'center' }}>
                  <Form.Item>
                    <b>Dashboard URL: </b> {alertUrl} <Button style={{ marginLeft: '20px', marginBottom: '10px' }} loading={formLoader} type='primary' onClick={this.addAlertUrl.bind(this)} className='Int-button'>Use Current Domain</Button>
