            ...
            <Content className='all-intergrations'>
              ...
              <Spin indicator={antIcon} spinning={alertUrlLoading} delay={100}>
                <Form layout='horizontal' style={{ textAlign: 'center' }}>
                  <Form.Item>
                    <b>Dashboard URL: </b> {alertUrl} <Button style={{ marginLeft: '20px', marginBottom: '10px' }} loading={formLoader} type='primary' onClick={this.addAlertUrl.bind(this)}>Use Current Domain</Button>
