              ...
              <Content className='setting-user'>
                ...
                <Tabs tabPosition='left'>
                  <TabPane tab={<span><Icon type='slack' />Slack</span>} key='2'>
                    ...
                    {slackDetails && <Result status='success' title='Slack Integrated' subTitle='You will receive notifications for app downtime and custom alerts directly on Slack.' extra={<Button type='danger' onClick={this.deleteSlack.bind(this)}> Remove Slack </Button>} />}
                  </TabPane>
                </Tabs>
              </Content>
            </Content>
