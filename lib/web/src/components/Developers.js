            ...
            <Content className='all-users'>
              <Content>
                ...
                {isAdmin &&
                  <Form layout='inline'>
                    <Form.Item>
                      <Input value={addUserEmail} style={{ width: '300px' }} name='addUserEmail' prefix={<UserOutlined style={{ color: 'rgba(0,0,0,.25)' }} autocomplete='off' />} placeholder='Developer Email' onChange={this.handleFormChange.bind(this)} />
                      <Input.Password value={addUserPassword} style={{ marginLeft: '16px', width: '300px' }} name='addUserPassword' prefix={<LockOutlined style={{ color: 'rgba(0,0,0,.25)' }} autocomplete='off' />} placeholder='Password' onChange={this.handleFormChange.bind(this)} />
                    </Form.Item>
                    <Form.Item>
