            ...
            <Content className='all-users'>
              <Content className='setting-user'>
                ...
                {isAdmin &&
                  <Form layout='inline'>
                    <Form.Item>
                      <Input value={addUserEmail} style={{ width: '200px' }} name='addUserEmail' prefix={<Icon type='user' style={{ color: 'rgba(0,0,0,.25)' }} />} placeholder='Developer Email' onChange={this.handleFormChange.bind(this)} />
                      <Input.Password value={addUserPassword} style={{ marginLeft: '16px', width: '200px' }} name='addUserPassword' prefix={<Icon type='lock' style={{ color: 'rgba(0,0,0,.25)' }} />} placeholder='Password' onChange={this.handleFormChange.bind(this)} />
                    </Form.Item>
                    <Form.Item>
