          ...
          <Row>
            ...
            <Col span={5}>
              <div className='github-star-button'>
                <a target='_blank' className='github-button' href='https://github.com/errsole/errsole.js' data-color-scheme='no-preference: light; light: light; dark: dark;' data-icon='octicon-star' data-size='large' aria-label='Star errsole/errsole.js on GitHub' rel='noreferrer'>Give us a Github Star</a>
              </div>
            </Col>
            <Col span={1}>
