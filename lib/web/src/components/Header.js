        ...
        <Modal title='Settings' centered closable maskClosable footer={null} visible={settingModalStatus} onCancel={this.closeSettingsModal.bind(this)} destroyOnClose>
          <Tabs>
            <TabPane tab='Change Password' key='1'>
              <br />
              <p><b>Current Password:</b> <Input type='password' name='currentPassword' style={{ color: 'black', width: '100%' }} onChange={this.handleFormInputChange.bind(this)} /></p>
              <br />
              <p><b>New Password:</b> <Input type='password' name='password' style={{ color: 'black', width: '100%' }} onChange={this.handleFormInputChange.bind(this)} /></p>
              <br />
              <p><b>Confirm Password:</b> <Input type='password' name='confirm_password' style={{ color: 'black', width: '100%' }} onChange={this.handleFormInputChange.bind(this)} /></p>
              <br />
