...
import { LikeOutlined, BugOutlined, StarOutlined, UserOutlined } from '@ant-design/icons';
          ...
          <Row>
            ...
            <Col span={10}>
              <div className='github-star-button'>
                <a target='_blank' className='feedback-share-button' href='https://forms.gle/1pJ3jrNH2BSd3mu29' rel='noreferrer'>
                  <Button type='secondary' icon={<LikeOutlined />}>Share your feedback</Button>
                </a>
                <a target='_blank' className='github-issue-button' href='https://github.com/errsole/errsole.js/issues' rel='noreferrer'>
                  <Button type='secondary' icon={<BugOutlined />}>Report an issue</Button>
                </a>
                <a target='_blank' className='github-button' href='https://github.com/errsole/errsole.js' rel='noreferrer'>
                  <Button type='secondary' icon={<StarOutlined />}>Give us a GitHub star</Button>
                </a>
              </div>
            </Col>
            <Col span={1}>
