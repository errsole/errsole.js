          ...
          <Row>
            ...
            <Col span={10}>
              <div className='github-star-button'>
                <a target='_blank' className='linkedin-share-button' href='https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Fgithub.com%2Ferrsole%2Ferrsole' rel='noreferrer'><Button type='secondary' icon='share-alt'>Share on LinkedIn</Button></a>
                <a target='_blank' className='github-issue-button' href='https://github.com/errsole/errsole.js/issues' rel='noreferrer'><Button type='secondary' icon='bug'>Report an issue</Button></a>
                <a target='_blank' className='github-button' href='https://github.com/errsole/errsole.js' rel='noreferrer'><Button type='secondary' icon='star'>Give us a GitHub star</Button></a>
              </div>
            </Col>
            <Col span={1}>
