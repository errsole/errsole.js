              ...
              {totalUsers > 0 &&
                <Form layout='vertical' onKeyDown={(event) => event.key === 'Enter' && this.login()}>
                  ...
                  <Form.Item>
                    ...
                    <Alert className='info-class' message='Rishi is the admin. Please request Rishi to add you to the app developers and provide you with the login credentials.' type='info' />
                  </Form.Item>
                </Form>}
            </Col>
            <Col xs={1} sm={3} md={9} lg={9} xl={9} />
