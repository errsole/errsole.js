...
class Login extends React.Component {
  ...
  componentDidMount () {
    ...
    this.props.userActions.getAdminName(function (err, response) {
      if (!err && response && response.attributes && response.attributes.name) {
        self.setState({ adminName: response.attributes.name });
      }
    });
                  ...
                  <Form.Item>
                    ...
                    {adminName && adminName.trim() !== '' && (
                      <Alert
                        ...
                        message={`${adminName} is the admin. Please request ${adminName} to add you to the app developers and provide you with the login credentials.`}
                        type='info'
                      />
                    )}
                  </Form.Item>
