    ...
    this.interval = setInterval(() => {
      this.setState(
        ...
        () => {
          ...
          if (this.state.timer >= 1 && !this.state.isPopUpVisible) {
          ...
          {this.state.isPopUpVisible && (
            <Modal
              ...
              footer={[
                ...
                <Button key='skip' onClick={this.handleSkip}>
                  Skip
                </Button>,
            ...
            >
              <p>Do you find Errsole useful? Please share your experience!</p>
              <p>Your feedback would mean a lot—it motivates the contributors to make Errsole better.</p>
              <p><a href='https://forms.gle/1pJ3jrNH2BSd3mu29' target='_blank' rel='noreferrer'>Click Here</a></p>
            </Modal>
          )}
          <div
            className='overlay'
