  ...
  render () {
    ...
    return (
      <>
        ...
        {updateLevel &&
          <Modal title={updateLevel + ' version available'} visible={showUpdateModel} closable={false} okText='Ok' cancelText='' cancelButtonProps={{ disabled: true }} onOk={this.errsoleUpdateModel.bind(this, false)} footer={[<Button key='submit' type='primary' onClick={this.errsoleUpdateModel.bind(this, false)}> Ok</Button>]}>
            <p> {updateLevel} version is available. Please update the modules</p>
          </Modal>}
      </>
    );
  }
