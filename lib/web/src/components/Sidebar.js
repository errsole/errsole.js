...
class Sidebar extends React.Component {
  ...
  render () {
    ...
    if (updates) {
      ...
      if (errsoleUpdates.updateNeeded && storageUpdates.updateNeeded) {
        msg1 = 'A ' + errsoleUpdates.level + ' version of the ' + updates.name + ' and ' + storageUpdates.level + ' version of ' + updates.storage_name + ' module has been released. Currently, you are using ' + updates.name + ' v' + updates.version + ' and ' + storageUpdates.name + 'v' + updates.storage_version;
