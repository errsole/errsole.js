...
class Sidebar extends React.Component {
  ...
  render () {
    ...
    if (updates) {
      ...
      if (errsoleUpdates.updateNeeded && storageUpdates.updateNeeded) {
        if (errsoleUpdates.level === storageUpdates.level) {
          msg1 = 'A ' + errsoleUpdates.level + ' version of the ' + updates.name + ' and ' + updates.storage_name + ' modules have been released. Currently, you are using ' + updates.name + ' v' + updates.version + ' and ' + storageUpdates.name + ' v' + updates.storage_version;
        } else {
          msg1 = 'A ' + errsoleUpdates.level + ' version of the ' + updates.name + ' and a ' + storageUpdates.level + ' version of ' + updates.storage_name + ' modules have been released. Currently, you are using ' + updates.name + ' v' + updates.version + ' and ' + storageUpdates.name + ' v' + updates.storage_version;
        }
        ...
        msg1 = 'A ' + errsoleUpdates.level + ' version of the ' + updates.name + ' module has been released. Currently, you are using ' + updates.name + ' v' + updates.version;
        install = 'npm install errsole@' + updates.latest_version;
      } else if (storageUpdates.updateNeeded) {
        msg1 = 'A ' + storageUpdates.level + ' version of the ' + storageUpdates.name + ' module has been released. Currently, you are using ' + storageUpdates.name + ' v' + updates.storage_version;
